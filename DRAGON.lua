...
sudo_users = {SUDO,1721540719,70,70,70,70}   
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'شيكو') 
local DRAGON_Msg = { 
...
if not DevSoFi(msg) then
local Text = [[
𖤛سعر التنصيب علي سورس شيكو 
💖سعر التنصيب العادي 25 جنيه فقط
𖤛للتواصل اتبع الازرار بالاسف
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖤛• ⁽𖤛شيكو𖤛₎ •𖤛❩',url="t.me/xx_shico"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖤛• ≪━━━━ شيكو━━━━≫₎ •𖤛❩',url="t.me/xx_shico"}},
{{text = '《𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛》',url="t.me/xx_Source_JACK"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
send(msg.chat_id_, msg.id_,' 𖤛 اصدار سورس شيكو{ 3x☆}')
end
...
local Text = [[ 
[قناه سورس شيكو ادخل وتابع الجديد](t.me/xx_Source_JACK)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛》', url="t.me/xx_Source_JACK"}}, 
...
if text == 'شيكو مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
↝المبرمج شيكو لو حابب تتواصل معاه
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 𖤛 من أحسن السورسات على التليجرام سورس شيكو 𖤛
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "شيكو")
...
local Text =[[
╭𖤛━┅⟞⟦[𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛](http://t.me/xx_Source_JACK)⟧⟝┉━𖤛╮
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 𖤛شيكو𖤛', url = "https://t.me/xx_shico"}},
{{text = '𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛', url = "https://t.me/xx_Source_JACK"}},
}
local msg_id = msg.id_/2097152/0.5
...
local Text = [[
 𖠪 اهلا بك في سورس شيكو الجمدان 𖠪
...
if text == 'SHYCO' or text == 'SHYCO' or text == 'مبرمج السورس'  then
local Text = [[
المبرمج شيكو لو حابب تتواصل معه اتبع الزر الاسفل 👇💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖤛• ⁽ᯓ『SHYCO ‏. 』𓆃₎ •𖤛❩',url="t.me/xx_shico"}},
{{text = '《𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛》',url="t.me/xx_Source_JACK"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'شيكو' or text == 'شيكو' or text == 'مطور السورس'  then
local Text = [[
شيكو مطور سورس شيكو للتواصل معه اتبع الزر الاسفل 👇💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖤛• ⁽𖤛شيكو𖤛₎ •𖤛',url="t.me/xx_shico"}},
...
local Text = [[ 
مطورين ومبرمجين سورس شيكو اتبع الازرار للتواصل معهم 👇🧿
]]
keyboard = {}  
keyboard.inline_keyboard = { 
...
if text == "تصميم شيكو" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(1,3); 
local Text ='تم اختيار تصميم من تصميمات شيكو هذه لك' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨  𖤛• ≪━━━━ شيكو━━━━≫₎ •𖤛 ❩', url="t.me/xx_shico"}},
{{text = '《𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛》',url="t.me/xx_Source_JACK"}},
...
local Text = [[ 
 𖤛من أحسن السورسات على التليجرام سورس شيكو 𖤛
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/UU_M00N/3785/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'العاب شيكو' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 𖤛 اهلا في قائمه الالعاب المتطوره سورس شيكو 𖤛 
...
send(msg.chat_id_, msg.id_," 𖤛 عذرا الملف لايدعم سورس شيكو\n") 
end
return false
end
...
if text == ("مسح قائمه شيكو") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 𖤛 تم مسح قائمه شيكو')
return false
end

if text == 'قائمه شيكو' and Sudo(msg) then
...
if text == ("رفع شيكو") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع شيكو@(.*)$") and Sudo(msg) then
local username = text:match("^رفع شيكو@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع شيكو(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع شيكو(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل شيكو") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل شيكو@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل شيكو@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل شيكو(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل شيكو(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'شيكو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'شيكو')
local DRAGON_Msg = {
'نعم يروحي♥️🙈',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
'دوختو  '..Namebot..'',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس شيكوو🙈♥️',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي 😾',
...
end --الكود حصري سورس شيكويعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'شيكو').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/xx_Source_JACK)')
return false
end
...
[🎯ألعاب سورس شيكو الاحسن في التليجرام .↑]
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 [《𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛》 ](t.me/xx_Source_JACK)
]]
keyboard = {} 
...
local Teext =[[
 𖤛مرحب  بك في مميزات سورس شيكو 𖤛
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'شيكو')
