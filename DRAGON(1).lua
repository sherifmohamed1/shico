...
io.write('\27[0;31m\n ارسل لي توكن البوت الان 𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي 𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘\n\27[0;33;49m')
...
io.write('\27[1;31m 𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘 ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘"
echo "TG IS NOT FIND IN FILES BOT"
echo "𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘 𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘"
exit 1
fi
if [ ! $token ]; then
echo "𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘 𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘"
...
token = sudos.token 
--- start functions 𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘
--------------------------------------------------------------------------------------------------------------
...
sudo_users = {SUDO,1721540719,70007,70,700,70007}   
...
var = true 
elseif tonumber(user_id) == tonumber(700) then
var = true  
elseif tonumber(user_id) == tonumber(70) then
var = true  
elseif tonumber(user_id) == tonumber(70007) then
var = true  
elseif tonumber(user_id) == tonumber(70007) then
var = true  
...
elseif tonumber(user_id) == tonumber(700) then
var = 'صاحب السورس'
elseif tonumber(user_id) == tonumber(7000) then
var = 'مالك السورس'
elseif tonumber(user_id) == tonumber(70007) then
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(SUDO) then
...
local UserName = (data.username_ or "xx_shico_x")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼《〠𝐒𝐎𝐔𝐑𝐒𝐄 SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩〠》")  
...
if not DevSoFi(msg) then
local Text = [[
〠سعر التنصيب علي سورس شيكو 
💌سعر التنصيب العادي 25 جنيه فقط
〠للتواصل اتبع الازرار بالاسف
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖣘• ⁽〠SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩〠₎ •𖣘❩',url="t.me/xx_shico"}},
{{text = '《〠𝐒𝐎𝐔𝐑𝐒𝐄 SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩〠》',url="t.me/xx_shico_x"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖣘• ⁽ᯓ『تيجو ‏. 』𓆃₎ •𖣘❩',url="t.me/mo1ibrahim5"}},
{{text = '《〠𝐒𝐎𝐔𝐑𝐒𝐄 SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩〠》',url="t.me/xx_shico_x"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
local Text = ' 〠تم ارسال الملصق من 𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘\n - '..Name
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/xx_shico_x/83/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,' 〠 اصدار سورس شيكو{ 3x☆}')
end
...
if text == '𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس شيكو ادخل وتابع الجديد](t.me/xx_shico_x)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《〠𝐒𝐎𝐔𝐑𝐒𝐄 SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩〠》', url="t.me/xx_shico_x"}}, 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/xx_shico_x/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '━┅┅┄⟞⟦〠𝐒𝐎𝐔𝐑𝐒𝐄 SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩〠⟧⟝┄┉┉━' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس شيكو ادخل وتابع الجديد](t.me/xx_shico_x)
]] 
keyboard = {}  
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/xx_shico_x)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/xx_shico_x"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'شيكومبرمج السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
↝المبرمج شيكولو حابب تتواصل معاه
اتبع الزر إلى تحت 𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘↜
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨𖣘• ⁽ᯓ『تيجو ‏. 』𓆃₎ •𖣘❩', url="t.me/mo1ibrahim5"}}, 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 〠 من أحسن السورسات على التليجرام سورس شيكو 〠
...
send(msg.chat_id_,0," 〠 الـعـضو  : {["..data.first_name_.."](T.ME/xx_shico_x)}\n 〠 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 〠 عذرا  ⇇{["..data.first_name_.."](T.ME/xx_shico_x)}\n 〠 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text =[[
╭𖣘━┅⟞⟦[〠𝐒𝐎𝐔𝐑𝐒𝐄 SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩〠](http://t.me/xx_shico_x)⟧⟝┉━𖣘╮

    [⟦W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 〠𝐒𝐎𝐔𝐑𝐒𝐄 SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩〠⟧](http://t.me/xx_shico_x)

╰𖣘━┅⟞⟦[〠𝐒𝐎𝐔𝐑𝐒𝐄 SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩〠](http://t.me/xx_shico_x)⟧⟝┉━𖣘╯
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 〠SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩〠', url = "https://t.me/xx_shico"}},
{{text = '〠𝐒𝐎𝐔𝐑𝐒𝐄 SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩〠', url = "https://t.me/xx_shico_x"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'تايجر' or text == 'تايجر' or text == 'مبرمج السورس'  then
local Text = [[
المبرمج شيكولو حابب تتواصل معه اتبع الزر الاسفل ⬇️💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖣘• ⁽ᯓ『تيجو ‏. 』𓆃₎ •𖣘❩',url="t.me/mo1ibrahim5"}},
...
local Text = [[
شيكو مطور سورس شيكو للتواصل معه اتبع الزر الاسفل ⬇️💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ❨𖣘• ⁽〠SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩〠₎ •𖣘',url="t.me/xx_shico"}},
...
local Text = [[ 
مطورين ومبرمجين سورس شيكو اتبع الازرار للتواصل معهم ⬇️🧿
]]
keyboard = {}  
keyboard.inline_keyboard = { 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/xx_shico_x&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == '《〠𝐒𝐎𝐔𝐑𝐒𝐄 SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩〠》' then
local Text = [[ 
 〠من أحسن السورسات على التليجرام سورس شيكو 〠
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/xx_shico_x/84&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
〠 روايات ← لعرض الميزه
〠 ثيم ← لعرض الميزه
〠 تصميم شيكو← لعرض الميزه
〠 غنيلي بفيديو← لعرض الميزه
〠 همسه ← لعرض الميزه
〠 معني + اسمك ← لعرض الميزه
〠 خلفيات ← لعرض الميزه
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
〠 𝘾𝙃 - [《〠𝐒𝐎𝐔𝐑𝐒𝐄 SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩〠》](t.me/xx_shico_x) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨  𖣘• ⁽ᯓ『تيجو ‏. 』𓆃₎ •𖣘 ❩', url="t.me/mo1ibrahim5"}},
{{text = '❨  𖣘• ⁽𝚅𝙸𝙺𝙸𝙽𝙶₎ •𖣘 ❩', url="t.me/xx_shico_x"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendVideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/xx_shico_x/83/6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'العاب شيكو' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 〠 اهلا في قائمه الالعاب المتطوره سورس شيكو 〠 
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/xx_shico_x)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
if tonumber(result.sender_user_id_) == tonumber(700) then  
...
if tonumber(result.sender_user_id_) == tonumber(70007) then  
...
function(arg,data) 
usertext = '\n 〠 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'xx_shico_x')..')'
...
if result.id_ == tonumber(700) then
...
if result.id_ == tonumber(70007) then
send(msg.chat_id_, msg.id_, " ?? لا يمكنك حظر مالك السورس \n")
return false 
end
usertext = '\n 〠 الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'xx_shico_x')..')'
status  = '\n 〠 تم حظرو عام من الجروبات '
texts = usertext..status
...
if tonumber(userid) == tonumber(700) then  
send(msg.chat_id_, msg.id_, " 〠 لا تسطيع حظر صاحب السورس عام")
return false 
end
...
if tonumber(userid) == tonumber(70007) then  
send(msg.chat_id_, msg.id_, " 〠 لا تسطيع حظر مالك السورس عام")
return false 
end
...
t = ' 〠 ملفات السورس شيكو𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘\n 𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝚅??𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘 \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if Get_info then
local TextS = "\n 〠 اهلا بك في متجر ملفات شيكو\n 〠 ملفات السورس 𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘\n 〠 علامة تعني { ✔️ } ملف مفعل\n 〠 علامة تعني { ✖ } ملف معطل\n 〠 قناة سورس شيكو𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘\n".." 〠 [اضغط هنا لدخول](t.me/xx_shico_x) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 〠 عذرا الملف لايدعم سورس شيكو\n") 
end
return false
end
...
t = "\n 〠 قائمه زوجات الجروب \n 〠═───═❲[《〠𝐒𝐎𝐔𝐑𝐒𝐄 SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩〠》 ](t.me/xx_shico_x)❳═───═??\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
' }\nء⧬━┅┅┄⟞❲[〠𝐒𝐎𝐔𝐑𝐒𝐄 SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩〠](t.me/xx_shico_x)❳⟝┄┉┉━⧬'..
'\n 〠  علامة ال {✓} تعني مفعل'..
'\n 〠  علامة ال {✘} تعني معطل'..
'\nء𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘'..
'\n'..' 〠  امر صيح  ⇇{ '..kickme..
...
' }\n'..' 〠  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' 〠  الرفع  ⇇{ '..setadd..
' }\n'..' 〠  الحظر  ⇇{ '..banm..' }\n\n 〠═───═❲[《〠𝐒𝐎𝐔𝐑𝐒𝐄 SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩〠》 ](t.me/xx_shico_x)❳═───═ 〠\n 〠 قناة سورس شيكو𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘\n [ ❲[《〠𝐒𝐎𝐔𝐑𝐒𝐄 SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩〠》 ](t.me/xx_shico_x)❳](t.me/xx_shico_x) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘\nاضغط علي الاسم ليتم نسخه\n𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘ٴ\n 〠 ❲[《〠𝐒𝐎𝐔𝐑𝐒𝐄 SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩〠》 ](t.me/xx_shico_x)❳ 〠 ')
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/xx_shico_x/55/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/xx_shico_x/53/18&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/xx_shico_x/39/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'عاش' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/xx_shico_x/27/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'اجري' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/xx_shico_x/30/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'لا' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/xx_shico_x/34/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'الو' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/xx_shico_x/41/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'حبك' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/xx_shico_x/13/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❨  𖣘• ⁽〠SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩〠₎ •𖣘 ❩', url="t.me/mo1ibrahim5"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/xx_shico_x/72/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'قمر' then
local Text = [[
]]
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/xx_shico_x/76/14&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/xx_shico_x/43/18&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'النشال' then
local Text = [[
]]
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/xx_shico_x)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/xx_shico_x)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/xx_shico_x)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/xx_shico_x)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/xx_shico_x)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/xx_shico_x)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/xx_shico_x)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/xx_shico_x)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/xx_shico_x)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/xx_shico_x)')
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/xx_shico_x)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/xx_shico_x)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/xx_shico_x)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/xx_shico_x)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..〠♥️](t.me/xx_shico_x)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/xx_shico_x)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/xx_shico_x)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/xx_shico_x)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/xx_shico_x)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/xx_shico_x)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/xx_shico_x)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤〠](t.me/xx_shico_x)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/xx_shico_x)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/xx_shico_x)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..〠💕](t.me/xx_shico_x)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/xx_shico_x)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي مش هروح ..😹👻](t.me/xx_shico_x)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/xx_shico_x)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/xx_shico_x)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..〠💕](t.me/xx_shico_x)')
return false
end
end
end
...
[[
🌨𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘Use ⇨ #username 🌨
🌨𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘iD ⇨ #id 🌨
🌨𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘Sta ⇨  #stast 🌨
🌨𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘Msg ⇨ #msgs 🌨
🌨𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘NaMe ⇨ #name  🌨
]],
[[
- ᴜѕᴇʀɴᴀᴍᴇ ➣ #username .
- ᴍѕɢѕ ➣ #msgs .
...
[[
↑𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username 〠  
↑𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘𝙄𝘿 ➱ #id
↑𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘𝙍𝘼𝙉𝙆 ➱  #stast 〠  
↑𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘𝙈𝘼𝙎𝙂 ➱ #msgs 〠  
↑𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘𝗖𝗛 ➯  ↝@xx_shico_x↜ 〠  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
?? 𝟔 𖡻 #msgs  ࿇🦄
...
local Text = [[
 ...
 تحت لي في الزر الأسفل𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘
 اختر الامر الذي تريدها .↑𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘
ده من الازرار بلاسفل . 𖣘━┅┄⟞⟦SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩⟧⟝┄┉━𖣘
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[《〠𝐒𝐎𝐔𝐑𝐒𝐄 SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩〠》 ](t.me/xx_shico_x)❳ 
]]
keyboard = {} 
...
if Text == '/add' then
local Teext =[[
🎮 اهلا بك في قسم الالعاب ..↑⟦〠𝐒𝐎𝐔𝐑𝐒𝐄 SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩〠⟧
🕹 اختر العبه الذي تريدفي الاسفل ..↑⟦〠𝐒𝐎𝐔𝐑𝐒𝐄 SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩〠⟧
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[《〠𝐒𝐎𝐔𝐑𝐒𝐄 SH. Y. C. O. ⛧✹ ⃝⃙🇲🇩〠》 ](t.me/xx_shico_x)❳ 
]]
keyboard = {} 
